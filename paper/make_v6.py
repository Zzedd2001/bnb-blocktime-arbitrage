...
E = ("## Appendix E. Replication package\n\n"
     ...
     "The replication package (https://github.com/Zzedd2001/bnb-blocktime-arbitrage; the arbitrage-level tables are attached to its Release v6.0) contains (i) the data pipeline — timestamp reconstruction from sparse headers, event retrieval, alignment to both references, arbitrage identification, LP economics at both mark-out horizons, hourly panels, "
